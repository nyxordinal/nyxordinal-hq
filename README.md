# Nyxordinal Headquarter

This project is the headquarter of `Nyxordinal`, developed with open-source template by [cruip.com](https://github.com/cruip/open-react-template)
